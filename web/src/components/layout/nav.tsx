...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: '/stratflow-mock', label: '策略流 Mock', icon: <PartitionOutlined />, group: '通话测试场景' },
    ],
  },
  {
    label: '观测',
    items: [
      ...
      { key: '/sms-mock', label: '短信 Mock', icon: <MessageOutlined />, group: '观测' },
    ],
  },
]
