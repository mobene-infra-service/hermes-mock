...
export default function ScenarioRecords({ scenario, caseKinds, title = '本场景记录', altLabel, altScenario, filterCustomers, sinceMs }: ScenarioRecordsProps) {
  ...
  const load = useCallback(async (silent = false) => {
    ...
    try {
      if (view === 'runs') {
        ...
        const r = await queryCallRecords({ scenario: activeScenario, page: 1, pageSize: 200 })
  ...
  }, [view, activeScenario, caseKinds, clientFilter, filterCustomers, sinceMs])
